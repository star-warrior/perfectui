    ...
    <div className="rounded-lg border border-[var(--border-color)]">
      ...
      <div className="px-4 py-2">
        ...
        <div className="flex items-center gap-4 py-2 font-semibold text-[length:var(--text-sm)]">
          <button className="bg-[var(--primary-color)] hover:bg-blue-600 text-white text-sm px-3 py-2 rounded">
            Generate
          </button>
          <p className="text-xs text-gray-400">Maximum 3 Colors</p>
        </div>
      </div>
    </div>
  );
